...
def get_training_dataset(seed, seqlen, model_path, dataset_name="wikitext2"):
    ...
    for i in range(0, total_samples * seqlen, seqlen):
        j = i + seqlen
...
def get_loaders(
    ...
    if 'wikitext2' in name:
        return get_training_dataset(seed, seqlen, model, 'wikitext2')
    if 'ptb' in name:
        if 'new' in name:
    ...
    if 'c4' in name:
        ...
        return get_training_dataset(seed, seqlen, model, 'c4')
